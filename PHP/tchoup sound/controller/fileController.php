...
class FileController
{
    ...
    public function upload($type, $titre)
    {
        ...
        if ($this->extension($extension, $type) === true) {

            //On modifie le nom du fichier
            // $fileName= microtime(true) . '.' . $extention;
            $nomModifier = $titre . $type . '.' . $extension;

            //va indiquer la position ET le nom
            $fichier = "song/" . basename($nomModifier);
